	...
	export default {
		...
		methods: {
			...
			showCreateEventPage(value){
				...
				if (value) {
					this.setEventId(this.trip_activity_tickets[0].id);
					this.setEventName(this.trip_activity_tickets[0].name);
					this.setMinEventJoiners(this.trip_activity_tickets[0].min_participant_for_gp_activity);
					this.setMaxEventJoiners(this.trip_activity_tickets[0].max_participant_for_gp_activity);
				}
			},
			setEventId(id){
