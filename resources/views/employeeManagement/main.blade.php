        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{url('/employee/dashboard')}}" class="waves-effect"><i class="zmdi zmdi-view-dashboard"></i> <span> dashboard </span> </a>
                    </li>
                    <li id="side-menu-trip-introduction">
                        <a href="{{url('/employee/trip_activity_gallery')}}" class="waves-effect"><i class="fa fa-suitcase"></i> <span>Trip activity </span> </a>
                    </li>
                    <li>
                        <a href="{{url('/employee/transaction_record')}}"><span>Transaction Record </span></a>
                    </li>
                </ul>
            </div>
        </div>
