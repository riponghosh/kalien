                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a type="button" class="cancel-pending btn btn-danger disabled" data-appointment_id="{{$trip_appointment->id}}" data-loading-text="<i class='fa fa-spinner fa-spin '></i> processing">Be rejected</a>
                                </div>
                            </div>
                        </div>
