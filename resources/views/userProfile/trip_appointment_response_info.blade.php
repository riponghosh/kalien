                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a type="button" class="cancel-pending btn btn-warning" data-appointment_id="{{$trip_appointment->id}}" data-loading-text="<i class='fa fa-spinner fa-spin '></i> processing">Cancel pending</a>
                                </div>
                            </div>
                        </div>
...
@section('script')
<script>
    $('.cancel-pending.btn').click(function(e){
        e.preventDefault();
        var $btn = $(this);
        cancelTripAppointment($btn.data('appointment_id')).done(function(res){
            if(res.success == true) {
                alert('取消請求成功!');
                window.location = '/';
