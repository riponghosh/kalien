...
class Product extends Model
{
    ...
    public function trip_activity_tickets(){
        return $this->hasMany('App\TripActivityTicket', 'trip_activity_id', 'id');
    }
    public function trip_activity_short_intros(){
        return $this->hasMany('App\Product\TripActivityShortIntro', 'trip_activity_id', 'id');
    }
    public function trip_activity_refund_rules(){
        return $this->hasMany('App\Product\TripActivityRefundRule','trip_activity_id','id');
    }

    public function rule_infos(){
        return $this->hasMany('App\Product\TripActivityRuleInfo','trip_activity_id','id');
    }

    public function customer_rights(){
        return $this->hasMany('App\Product\ProductCustomerRight', 'trip_activity_id', 'id');
    }
