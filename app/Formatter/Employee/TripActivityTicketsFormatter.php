...
class TripActivityTicketsFormatter implements IFormatter
{
    ...
    public function __construct(GpBuyingStatusFormatter $gpBuyingStatusFormatter, TicketIncidentalCouponsFormatter $ticketIncidentalCouponsFormatter, PackageDisableDatesFormatter $packageDisableDatesFormatter, PackageDisableWeekFormatter $packageDisableWeekFormatter)
    {
